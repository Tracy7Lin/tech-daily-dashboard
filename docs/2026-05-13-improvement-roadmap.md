...
截至当前状态，建议按下面的状态理解各条改进线：

- `Research Assistant v3`：进行中
- `信源广度与信息量增强`：进行中
- `主题研究深化`：部分完成，待继续
- `运维与可观测性`：达到稳定基线
- `信源可靠性`：低优先级待观察
...
- 部分完成
- dossier、tracking 与 dossier-aware chat 已经打通
- 但更强的研究表达一致性还未完成
...
- 已完成基线
- 目前更多作为 research assistant 与 UI 的输入层，而不是单独主线
...
- 暂停
- 当前首页与杂志化风格方向尚未稳定，旧的前端计划不应继续被视作有效执行基线
