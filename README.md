...
从 `2026-05-25` 开始，运行时研究助理进一步升级成了 `adaptive research assistant`：

- 如果日报知识层里有直接证据，会优先基于日报内容回答
- 如果日报里只有部分信息，会结合日报依据与模型补充解释
- 如果日报里没有直接信息，也允许回答一般科技知识，但会明确提示“非日报依据，仅供参考”
...
- 增加专题跟踪 agent，用单主专题方式持续跟踪最近几天最值得继续盯的主题与参与公司差异
