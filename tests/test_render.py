...
class RenderTests(unittest.TestCase):
    def test_render_index_contains_topic_section(self) -> None:
        ...
        self.assertNotIn("left-rail", html)
        self.assertNotIn("right-rail", html)
        self.assertIn("home-header", html)
        self.assertIn("publication-brand", html)
        self.assertIn("front-intro", html)
        self.assertIn("front-intro-title", html)
        self.assertIn("front-page", html)
        self.assertIn("home-assistant-shell", html)
        self.assertNotIn("assistant-window-compact", html)
        self.assertIn("chat-launcher", html)
        self.assertNotIn("Research Assistant</h2>", html)
        self.assertIn("lead-story", html)
        self.assertIn("secondary-stories", html)
        self.assertIn("topic-panel", html)
        self.assertIn("Lead Story", html)
        self.assertIn("Topic Brief", html)
        self.assertIn("进入专题页", html)
        self.assertIn("进入当日日报", html)
        ...
        self.assertIn("story-expand", html)
        self.assertIn("story-detail", html)
        self.assertIn("查看原文", html)
        self.assertIn("--paper", html)
        self.assertIn("newspaper-divider", html)
        self.assertIn("topic-position-list", html)
        ...
        self.assertIn("这个主专题现在怎么理解？", html)
    ...
    def test_render_daily_includes_chat_agent_shell_when_context_present(self) -> None:
        ...
        self.assertIn("静态预览模式", html)
        self.assertIn("内嵌回答仅用于无服务时预览", html)
